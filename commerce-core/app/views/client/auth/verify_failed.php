                ...
                <div class="card custom-card">
                    <div class="card-body p-4 p-sm-5 text-center">
                        ...
                        <div class="d-grid gap-3 mb-4">
                            <a href="/client/auth/register" class="btn btn-primary-brand btn-lg"
                                style="font-size: 1rem">
                                Đăng ký lại
                            </a>
                            <a href="/client/auth/login" class="btn btn-outline-custom btn-lg" style="font-size: 1rem">
                                Đăng nhập
                            </a>
                        </div>

                        <div style="font-size: 0.9rem" class="text-muted border-top pt-4 mt-2">
                            Cần hỗ trợ?
                            <a href="mailto:dat82770@gmail.com" class="text-brand text-decoration-none fw-semibold">Liên
                                hệ với chúng tôi</a>
                        </div>
                    </div>
                </div>
